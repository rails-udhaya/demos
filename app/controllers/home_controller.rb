...
def myskills_reviewed_demo
		send_file("#{Rails.root}/public/myskills_reviewed_demo.xlsx" )
		Emailer.check_email("Tim","Testing #{Rails.env} myskills_reviewed_demo Tim ").deliver
end
...
def myskills_demo_second
		send_file("#{Rails.root}/public/myskills_demo_second.xlsx" )
		Emailer.check_email("https://www.odesk.com/mc/#thread/350585820","Testing #{Rails.env} myskills_demo_second Tim ").deliver
end

def myskills_demo_first
		send_file("#{Rails.root}/public/myskills_demo_first.xlsx" )
		Emailer.check_email("https://www.odesk.com/mc/#thread/350585820","Testing #{Rails.env} myskills_demo_first Tim ").deliver
end

def basketball_final
		send_file("#{Rails.root}/public/basketball_final.xlsx" )
		Emailer.check_email("https://www.odesk.com/mc/#thread/350585820","Testing #{Rails.env} basketball_final ").deliver
end
...
def fetch_twitter_has_tag_demo
				...
				Emailer.check_email(params[:link_in_url],"HAS TAG DEMO").deliver if Rails.env == "production"
end
